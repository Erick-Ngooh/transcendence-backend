import { Controller, Post, Param, Body, Put, Get, Delete, Req, NotFoundException, InternalServerErrorException } from '@nestjs/common';
...
export class GameController {
   ...
   * }
   */
  @Put('updateScore/:matchId/playerA')
   ...
   * }
   */
  @Put('updateScore/:matchId/playerB')
